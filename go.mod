...
require (
	...
	github.com/hugolify/hugolify-example-site v1.0.5 // indirect
	github.com/hugolify/hugolify-netlify-cms v1.1.9 // indirect
	github.com/hugolify/hugolify-theme v1.3.13 // indirect
