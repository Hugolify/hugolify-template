...
require (
	...
	github.com/hugolify/hugolify-decap-cms v1.14.1 // indirect
	github.com/hugolify/hugolify-example-site v1.2.0 // indirect
	github.com/hugolify/hugolify-theme v1.16.0 // indirect
